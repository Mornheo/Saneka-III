...
CREATE TABLE EXPEDIENTE (NUM_EXPEDIENTE INTEGER NOT NULL, ACTIVO BOOLEAN, NOTA_MEDIA_PROVISIONAL BIGINT, ALUMNO_DNI VARCHAR, TITULACION_CODIGO INTEGER, PRIMARY KEY (NUM_EXPEDIENTE))
