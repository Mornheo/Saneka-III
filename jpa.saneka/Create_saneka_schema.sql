CREATE TABLE ALUMNO (ID INTEGER NOT NULL, APELLIDO1 VARCHAR NOT NULL UNIQUE, APELLIDO2 VARCHAR, CP_NOTIFICACION VARCHAR, CREDITOS_CF INTEGER, CREDITOS_FB INTEGER, CREDITOS_OB INTEGER, CREDITOS_OP INTEGER, CREDITOS_PE INTEGER, CREDITOS_TF INTEGER, CREDITOS_SUPERADOS INTEGER, DNI VARCHAR NOT NULL UNIQUE, DIRECCION_NOTIFICACION VARCHAR, EMAIL_INSTITUCIONAL VARCHAR, EMAIL_PERSONAL VARCHAR, FECHA_MATRICULA VARCHAR, GRUPOS_ASIGNADOS VARCHAR, LOCALIDAD_NOTIFICACION VARCHAR, MOVIL VARCHAR, NOMBRE VARCHAR NOT NULL UNIQUE, NOTA_MEDIA DOUBLE, NUM_ARCHIVO INTEGER, NUM_EXPEDIENTE INTEGER, PROVINCIA_NOTIFICACCION VARCHAR, TELEFONO VARCHAR, TURNO_PREFERENTE VARCHAR, PRIMARY KEY (ID))
...
CREATE TABLE EXPEDIENTE (NUM_EXPEDIENTE INTEGER NOT NULL, ACTIVO BOOLEAN, NOTA_MEDIA_PROVISIONAL BIGINT, ALUMNO_ID INTEGER, TITULACION_CODIGO INTEGER, PRIMARY KEY (NUM_EXPEDIENTE))
