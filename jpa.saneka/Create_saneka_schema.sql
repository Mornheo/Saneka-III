...
CREATE TABLE CLASE (DIA INTEGER NOT NULL UNIQUE, HORA_INICIO VARCHAR NOT NULL UNIQUE, HORA_FIN VARCHAR, ASIGNATURA_REFERENCIA INTEGER NOT NULL, GRUPO_ID INTEGER NOT NULL UNIQUE, PRIMARY KEY (DIA, HORA_INICIO, GRUPO_ID))
...
CREATE TABLE EXPEDIENTE (NUM_EXPEDIENTE INTEGER NOT NULL, ACTIVO BOOLEAN, NOTA_MEDIA_PROVISIONAL BIGINT, ALUMNO_ID INTEGER NOT NULL, TITULACION_CODIGO INTEGER NOT NULL, PRIMARY KEY (NUM_EXPEDIENTE))
CREATE TABLE GRUPO (ID INTEGER NOT NULL, ASIGNAR VARCHAR, CURSO INTEGER NOT NULL UNIQUE, INGLES BOOLEAN NOT NULL, LETRA VARCHAR NOT NULL, PLAZAS INTEGER, TURNO VARCHAR NOT NULL, VISIBLE BOOLEAN, TITULACION_CODIGO INTEGER NOT NULL, PRIMARY KEY (ID))
